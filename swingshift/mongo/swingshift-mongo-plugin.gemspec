...
spec_file = "rubygem-swingshift-mongo-plugin.spec"
...
Gem::Specification.new do |s|
  ...
  s.files = Dir["{app,config,db,lib}/**/*"] + ["LICENSE", "COPYRIGHT", "Rakefile", "README.md", "swingshift-mongo-plugin.gemspec", "rubygem-swingshift-mongo-plugin.spec", "Gemfile"]
