require "#{File.dirname(__FILE__)}/api_models_v1"
...
template_list_get_v1 = RestApi_V1.new("/rest/application_templates")
template_list_get_v1.response_type = "application_templates"

domain_add_post_v1 = RestApi_V1.new("/rest/domains", "POST")
dom_id = gen_uuid[0..9]
...
app_post_v1 = RestApi_V1.new("/rest/domains/#{dom_id}/applications", "POST")
...
app_list_get_v1 = RestApi_V1.new("/rest/domains/#{dom_id}/applications")
...
app_get_v1 = RestApi_V1.new("/rest/domains/#{dom_id}/applications/#{app_name}")
app_get_v1.response = RestApplication_V1.new(app_name, app_type, dom_id, app_scale)
app_get_v1.response_type = 'application'

app_descriptor_get_v1 = RestApi_V1.new("/rest/domains/#{dom_id}/applications/#{app_name}/descriptor")
app_descriptor_get_v1.response_type = 'descriptor'

app_start_post_v1 = RestApi_V1.new("/rest/domains/#{dom_id}/applications/#{app_name}/events", "POST")
...
app_restart_post_v1 = RestApi_V1.new("/rest/domains/#{dom_id}/applications/#{app_name}/events", "POST")
...
app_stop_post_v1 = RestApi_V1.new("/rest/domains/#{dom_id}/applications/#{app_name}/events", "POST")
...
app_force_stop_post_v1 = RestApi_V1.new("/rest/domains/#{dom_id}/applications/#{app_name}/events", "POST")
...
app_add_alias_post_v1 = RestApi_V1.new("/rest/domains/#{dom_id}/applications/#{app_name}/events", "POST")
app_alias = 'myApp'
...
app_remove_alias_post_v1 = RestApi_V1.new("/rest/domains/#{dom_id}/applications/#{app_name}/events", "POST")
...
app_scale_up_post_v1 = RestApi_V1.new("/rest/domains/#{dom_id}/applications/#{app_name}/events", "POST")
...
app_scale_down_post_v1 = RestApi_V1.new("/rest/domains/#{dom_id}/applications/#{app_name}/events", "POST")
...
app_add_cart_post_v1 = RestApi_V1.new("/rest/domains/#{dom_id}/applications/#{app_name}/cartridges", "POST")
...
app_expose_port_post_v1 = RestApi_V1.new("/rest/domains/#{dom_id}/applications/#{app_name}/events", "POST")
...
app_show_port_post_v1 = RestApi_V1.new("/rest/domains/#{dom_id}/applications/#{app_name}/events", "POST")
...
app_gear_get_v1 = RestApi_V1.new("/rest/domains/#{dom_id}/applications/#{app_name}/gears")
app_gear_get_v1.response_type = 'gears'

app_gear_groups_get_v1 = RestApi_V1.new("/rest/domains/#{dom_id}/applications/#{app_name}/gear_groups")
app_gear_groups_get_v1.response_type = 'gear_groups'

app_conceal_port_post_v1 = RestApi_V1.new("/rest/domains/#{dom_id}/applications/#{app_name}/events", "POST")
...
app_cart_list_get_v1 = RestApi_V1.new("/rest/domains/#{dom_id}/applications/#{app_name}/cartridges")
app_cart_list_get_v1.response = RestCartridge_V1.new('embedded', embed_cart)
app_cart_list_get_v1.response_type = "cartridges"

app_cart_get_v1 = RestApi_V1.new("/rest/domains/#{dom_id}/applications/#{app_name}/cartridges/#{embed_cart}")
app_cart_get_v1.response = RestCartridge_V1.new('embedded', embed_cart)
app_cart_get_v1.response_type = "cartridge"

app_cart_start_post_v1 = RestApi_V1.new("/rest/domains/#{dom_id}/applications/#{app_name}/cartridges/#{embed_cart}/events", "POST")
...
app_cart_restart_post_v1 = RestApi_V1.new("/rest/domains/#{dom_id}/applications/#{app_name}/cartridges/#{embed_cart}/events", "POST")
...
app_cart_reload_post_v1 = RestApi_V1.new("/rest/domains/#{dom_id}/applications/#{app_name}/cartridges/#{embed_cart}/events", "POST")
...
app_cart_stop_post_v1 = RestApi_V1.new("/rest/domains/#{dom_id}/applications/#{app_name}/cartridges/#{embed_cart}/events", "POST")
...
app_cart_delete_v1 = RestApi_V1.new("/rest/domains/#{dom_id}/applications/#{app_name}/cartridges/#{embed_cart}", "DELETE")
...
app_delete_v1 = RestApi_V1.new("/rest/domains/#{dom_id}/applications/#{app_name}", "DELETE")

keys_delete_v1 = RestApi_V1.new("/rest/user/keys/#{kname}", "DELETE")

domain_delete_v1 = RestApi_V1.new("/rest/domains/#{dom_id}", "DELETE")
