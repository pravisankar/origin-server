class CartridgesController < BaseController
  ...
  def index
    ...
    render_success(:ok, "cartridges", cartridges.map{|c| RestCartridge11.new(nil,c,nil,nil,nil,nil,get_url,nil,nolinks)}, "LIST_CARTRIDGES", "List #{type.nil? ? 'all' : type} cartridges") 
  end
end
